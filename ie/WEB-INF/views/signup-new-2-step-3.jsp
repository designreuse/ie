...
<div class="wrapper">
	<%@include file="header.jsp" %>
		...
		<form:form  method="post" modelAttribute="dtoUser" enctype="multipart/form-data" action="saveNewClasses" id="saveSignupForm" class="register-form" >
		<input type="hidden" value="${userId}" name="userId" id="userId">
		<input type="hidden" id="selectedPrograms" name="selectedPrograms">
		<div class="steps_getstarted">
		<div class="container">
				<div class="pracProgress_hdr">
				<form:hidden path="subscriptionPlanId" value="${subscriptionPlanId}"/> 
				<h2>Get Started</h2>
					...
					<div class="container">					
					 <div class="section_makpaymnt">
						<div class="programs_our" id="ourProg">
							<div class="titlebar_programms bdrbtmnone">
								<h4 class="bdrbtmgrey">Add Classes</h4>
							...
							<div class="misc_tabs">
								<div class="misc_tabar background-none">
									...
									<li id="mtab1">
									<a class="trial" onclick="showTab(1);">${programsList.programDescDetail}</a>
									</li>
									</c:if>
									<c:if test="${programsList.programId == 2}">
									<li id="mtab2">
									<a class="trial" onclick="showTab(2);">${programsList.programDescDetail}</a>
									</li>
									</c:if>
									<c:if test="${programsList.programId == 3}">
									<li id="mtab3">
									<a class="trial" onclick="showTab(3);">${programsList.programDescDetail}</a>
									</li>
									</c:if>
									<c:if test="${programsList.programId == 4}">
									<li id="mtab4">
									<a class="trial" onclick="showTab(4);">${programsList.programDescDetail}</a>
									</li>
									</c:if>
									</c:forEach>
									</ul>
								...
								<div class="misc_content">
									<!--TAB 1 STARTS-->
									<div id="tab1">
									<div class="content_setup background-none" id="programDiv_1" style="display:none;">
										...
										<div id="divSection_1_0"> 
												...
												<div class="contact-row">
													<div class="outer-field-wrap ">
														<div class="outer-field">
															<input type="hidden" id="programId_1_0" name="programIds"/>
															<input placeholder="Class*" type="text" name="className_1_0" id="className_1_0" class="ignore1" onchange="setProgramId(this.value,0,1);"/>
														</div>
													</div>
												</div>
											</li><br/>
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap ">
														<div class="outer-field">
															<input placeholder="Teacher Name*" type="text" name="teacherName_1_0" id="teacherName_1_0" class="ignore1"/>
														</div>
													</div>
												</div>
											</li>
											<li>
												...
												<div class="contact-row">
													<div class="outer-field-wrap ">
														<div class="outer-field">
															<input placeholder="Teacher Email*" type="text" name="teacherEmail_1_0" id="teacherEmail_1_0" class="ignore1"/>
														</div>
													</div>
												</div>
												</div>
												 <!-- <input type="button" class="input_abs_plus">  -->
												 <div class="plusImg" id="removeLast_1_0"><a  title="Add More" onclick="addMoreClass(1,0);" id="addMoreClass_1"><img src="<%=request.getContextPath()%>/NewStyles/images/plus-icon.png" alt="Image" /></a></div> 
												</div>
											</li>
											</div>
											</div>
									...
									<div class="content_setup background-none" id="programDiv_2" style="display:none;">
									<div class="getstartForm">
										<ul>
								 		<div id="parentInfo_2">
										<div id="divSection_2_0"> 
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input type="hidden" id="programId_2_0" name="programIds"/>
															<input placeholder="Class*" type="text" name="className_2_0" id="className_2_0" class="ignore1" onchange="setProgramId(this.value,0,2);"/>
														</div>
													</div>
												</div>
											</li><br/>
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Name*" type="text" name="teacherName_2_0" id="teacherName_2_0" class="ignore1"/>
														</div>
													</div>
												</div>
											</li>
											<li>
												...
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Email*" type="text" name="teacherEmail_2_0" id="teacherEmail_2_0" class="ignore1"/>
														</div>
													</div>
												</div>
												</div>
												 <div class="plusImg" id="removeLast_2_0"><a  title="Add More" onclick="addMoreClass(2,0);" id="addMoreClass_2"><img src="<%=request.getContextPath()%>/NewStyles/images/plus-icon.png" alt="Image" /></a></div> 
												</div>
											</li>
											</div>
											</div>
									...
									<div class="content_setup background-none" id="programDiv_3" style="display:none;">
										...
										<div id="divSection_3_0"> 
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input type="hidden" id="programId_3_0" name="programIds"/>
															<input placeholder="Class*" type="text" name="className_3_0" id="className_3_0" class="ignore1" onchange="setProgramId(this.value,0,3);"/>
														</div>
													</div>
												</div>
											</li><br/>
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Name*" type="text" name="teacherName_3_0" id="teacherName_3_0" class="ignore1"/>
														</div>
													</div>
												</div>
											</li>
											<li>
												...
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Email*" type="text" name="teacherEmail_3_0" id="teacherEmail_3_0" class="ignore1"/>
														</div>
													</div>
												</div>
												</div>
												 <!-- <input type="button" class="input_abs_plus">  -->
												 <div class="plusImg" id="removeLast_3_0"><a  title="Add More" onclick="addMoreClass(3,0);" id="addMoreClass_3"><img src="<%=request.getContextPath()%>/NewStyles/images/plus-icon.png" alt="Image" /></a></div> 
												</div>
											</li>
											</div>
											</div>
									...
									<div class="content_setup background-none" id="programDiv_4" style="display:none;">
									<h5>${program.programDescDetail}</h5>
									<div class="getstartForm">
										<ul>
								 		<div id="parentInfo_4">
										<div id="divSection_4_0"> 
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input type="hidden" id="programId_4_0" name="programIds"/>
															<input placeholder="Class*" type="text" name="className_4_0" id="className_4_0" class="ignore1" onchange="setProgramId(this.value,0,4);"/>
														</div>
													</div>
												</div>
											</li><br/>
											<li>
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Name*" type="text" name="teacherName_4_0" id="teacherName_4_0" class="ignore1"/>
														</div>
													</div>
												</div>
											</li>
											<li>
												...
												<div class="contact-row">
													<div class="outer-field-wrap">
														<div class="outer-field">
															<input placeholder="Teacher Email*" type="text" name="teacherEmail_4_0" id="teacherEmail_4_0" class="ignore1"/>
														</div>
													</div>
												</div>
												</div>
												 <!-- <input type="button" class="input_abs_plus">  -->
												 <div class="plusImg" id="removeLast_4_0"><a  title="Add More" onclick="addMoreClass(4,0);" id="addMoreClass_4"><img src="<%=request.getContextPath()%>/NewStyles/images/plus-icon.png" alt="Image" /></a></div> 
												</div>
											</li>
											</div>
											</div>
							...
							<div id="tab1" >
	        					<div class="section_trial">
	                        		<div class="videobtn">
									<input type="button" onclick="addClasses();" value="Add Classes"  class="blueBtn padding-lt-rt-40" />
									<p>OR</p>
...
<script type="text/javascript" type="text/javascript" src="<%=request.getContextPath()%>/NewStyles/js/tab.js" ></script>
