	...
	<%@include file="header.jsp" %>
		...
		<section class="tehDsh-step1 ">
			...
			<div class="pracProgress_hdr">
				...
				<div class="videobtn">
					<input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/principal/training2';" />
				</div>
			</div>
		</section>
	</div>
