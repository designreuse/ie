...
<%@include file="header.jsp" %>
    ...
    <div class="inner_wrapper"> 
        ...
        <%-- <div class="startLeft">
						...
						<a href="<%=request.getContextPath()%>/principal/create-campaign" title="" class="startBtn">Create New Campaign</a>
					</div> --%>
            ...
            <div class="get_program_school">
                ...
                <div class="gps_wrapper">
                    <div class="content_inner">
                        ...
                        <%-- <a href="<%=request.getContextPath()%>/principal/donate" title="" class="startBtn">Contribute</a> --%>
                    </div>
                </div>
            </div>
            </c:forEach> 
