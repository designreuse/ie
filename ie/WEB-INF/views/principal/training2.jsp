...
<%-- 					<img src="<%=request.getContextPath()%>/NewStyles/images/logo.jpg" alt="Logo" title="logo" /> --%>
		...
		<section class="tehDsh-step1 ">
			<div class="containerSmall">
				...
				<div class="videobtn">
                <input type="button" class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/principal/training3';" value='PROCEED TO NEXT STEP' title="PROCEED TO NEXT STEP">
