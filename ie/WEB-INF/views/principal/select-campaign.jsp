        ...
        <div class="about_us">
            <div class="content_inner">
               ...
               <div class="cafrc_wrapper">
                ...
                <div class="txtcenter_align">
                <input type="button" onclick="location.href='<%=request.getContextPath()%>/principal/class-campaign';" value="Start Class Campaign" class="submit-btn mrgtp25">
                <input type="button" onclick="location.href='<%=request.getContextPath()%>/principal/school-campaign';" value="Start School Campaign" class="submit-btn mrgtp25">
                </div>
                </div>
                </div>
                </div>
