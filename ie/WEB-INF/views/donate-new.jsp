            ...
            <div class="content_inner">
                ...
                <div class="school_campaign">
                   <div class="containerSmall"> <div class="new_camp_changepic">
                    ...
                    <div class="tar_container tar_container-bar">
                        <div class="tar_wrapper">
		                     ...
		                     <div class="range_wrpr">
							    ...
							    <div class="progress-bar progress-bar-warning pinpoint gbarYellow" id="contributeSchool" role="progressbar" >
							     <!--  School Contribution
							      <div id="contriAmount"></div> -->
							    </div>
							    <c:if test="${i ne 0}">
							    <div class="progress-bar progress-bar-danger pinpoint gbarOrng" role="progressbar" id="donorContributedAmount" >
							    	<!-- Donor Contribution
							    <div id="donorAmount"></div> -->
							  	</div>
							  	</c:if>
							  	<c:if test="${i eq 0}">
							    <div class="progress-bar progress-bar-danger pinpoint gbarOrng-left-radius" role="progressbar" id="donorContributedAmount" >
							    	<!-- Donor Contribution
							    <div id="donorAmount"></div> -->
							  	</div>
							  	</c:if>
							    <div class="progress-bar progress-bar-success pinpoint gbarWhite" id="needAssistance" role="progressbar" >
							    ...
							    <div class="progress-bar progress-bar-overload pinpoint gbarBlue" role="progressbar" id="donorContributedAmountOverload" >
                    ...
                    <form:form role="form" id="donationForm" action="addDonation" class="register-form" modelAttribute="dtoDonor" method="post">
...
$(document).ready(function() { 
	...
	$("#totalDonationRaised").text("$"+parseInt(Number(totalDonationAmount)+Number(schoolConhtribution))+" raised till "+clientDate);
	 ...
	 if((Number(totalDonationAmount)+Number(schoolConhtribution))>(Number(totalAmount))){
		 ...
		 resultPer3 = 0;
		 $('#donorContributedAmountOverload').width("8%");
	 }else{
