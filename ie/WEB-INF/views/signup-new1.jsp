		       ...
		       <div class="num_steps_getstarted">
				...
				<div class="btns-outer mtop30 mbtm30">
			        ...
			        <div class="tmh_tabs">
				        ...
				        <li id="mtab1" style="float:none; border:1px solid #ddd; display:inline-block"><a  class="trailtab" style="background: #e1e1e1; color:#606872">Register Now &amp; Use it for 3 years</a>
				        ...
				        <li id="mtab2" style="float:none; border:1px solid #ddd; display:inline-block"><a  class="hutab" style="background: #e1e1e1;  color:#606872">Start a Campaign &amp; Get Lifetime Subscription</a>
