        ...
        <section class="get-started-new-sec">
        	<div class="container">
            	<div class="new-started-step">
                	<div class="containerSmall">
                	<form:form  method="post" modelAttribute="dtoUser" enctype="multipart/form-data" action="saveSignupPaymentTemp" id="saveSignupForm" class="register-form" >
						...
						<div class="containerSmall">
             				<div class="getstartForm">
				                <div class="check-select-out">
				                	...
				                	<c:if test="${schoolDetailTemp.paymentTypeId == 0}">
				                    	<p>Monthly subscription to start Innerexplorer in your school is $${principalSubAmtMntly}</p>
				                    </c:if>
