       ...
       <div class="pracProgress_hdr">
            ...
            <div class="green_line_btm"></div>
				...
				<form id="searchUserForm"
					action="<%=request.getContextPath()%>/searchResult" method="get">
					<input type="hidden" readonly="readonly" value="All"
									...
									<div class="contact-row">
										<div class="outer-field-wrap">
											<div class="outer-field">
												<input type="text" placeholder="keyword" name="searchKey"
													value="${sKeyword}" id="searchBox" data-toggle="tooltip"
													title="Type School Name or Person Name">
											</div>
										</div>
									</div>
								</div>
