...
<style>
.imgbg-full {
	background-image: url(NewStyles/images/Mindfulness-2.jpg);
...
<body>
	...
	<div>
		...
		<div class="imgbg-full"></div>

		<section>

			<div class="containerSmall">
				<form class="forget-form" action="firstLoginrequestcrim"
					method="post">
			...
			<c:if test="${invaildforgotRequest == '402'}">
				<font color="red" style="text-align: center; margin-left: -430px"
					id="invaildforgotRequest">Please enter valid email.</font>
			</c:if>
			<c:if test="${invaildforgotRequest=='403'}">
				<font color="red" style="text-align: center; margin-left: -430px"
					id="invaildforgotRequest">You are not authorized to perform
					this action.</font>
			</c:if>
			<c:if test="${invaildforgotRequest=='404'}">
				<font color="red" style="text-align: center; margin-left: -430px"
					id="invaildforgotRequest">You are not authorized to perform
					this action blocked by admin.</font>
			</c:if>
			<c:if test="${invaildforgotRequest=='401'}">
				<font color="red" style="text-align: center; margin-left: -430px"
					id="invaildforgotRequest">Internal server error.</font>
			</c:if>
		</section>
	</div>
...
<body
	class="home page page-id-5 page-template page-template-page-template page-template-home-page-tpl page-template-page-templatehome-page-tpl-php">
