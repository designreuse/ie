   ...
   <%@include file="header.jsp" %>
    ...
    <div class="steps_getstarted">
			<div class="containerSmall">
				...
				<div class="procod">
					<div class="procodIn">
						<p>Use Promo Code #WISDOM2.0 to launch IE Programs at a school of your choice, today</p>
					</div>
				</div>
					...
					<ul>
						<li>
							<div class="contact-row">
								<div class="outer-field-wrap">
									<div class="outer-field">
										<input type="text" placeholder="Name" id="nametext" name="name">
									</div>
								</div>
							</div>
						</li>
                        <li>
							<div class="contact-row">
								<div class="outer-field-wrap">
									<div class="outer-field">
										<input type="text" placeholder="Email" id="emailtext" name="email">
									</div>
								</div>
							</div>
						</li>
...
<form action="findSchoolByLatLongSponsor" id="submitLatlngForm" method="post">
