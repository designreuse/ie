				...
				<div class="check-select-out">
                	<div class="parent-dash-out" style="display:none;" id="notification">
                        ...
                        <div class="btns-outer float-none">
							<!-- <input class="submit-btn" type="submit" value="START PLAYING"> -->
							<p>
								...
								<img src="<%=request.getContextPath()%>/NewStyles/images/speaker.gif" alt="Inner Explorer" title="Inner Explorer" id="notify" onclick="loadTrack();"/>
							</p>
						</div>
                    </div>
                </div>
