   ...
   <%@include file="header.jsp" %>
    ...
    <div class="steps_getstarted">
			<div class="container">
				...
				<div class="procod margin-btm-zero">
					<div class="procodIn">
				...
				<div class="Clkur_grid">
					<div class="videobtn margin-bottom-ten">
						<a href="<%=request.getContextPath()%>/donor/brand-ambassador" class="blueBtn ">Look for School around you</a>
					</div>
					<div class="videobtn margin-bottom-ten">
						<a href="<%=request.getContextPath()%>/donor/brand-ambassador-manual" class="blueBtn">Search for School in specific Zip Area </a>
					</div>
					</div>
