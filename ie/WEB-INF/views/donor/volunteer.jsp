      ...
      <!--about_us starts-->
        <div class="about_us">
            <div class="content_inner">
                ...
                <img src="<%=request.getContextPath()%>/NewStyles/images/volunteer.jpg"  alt=""/> 
                </div>
               	
                <div class="act-cntnt margin-top-twnty">
                	
                    <div class="par-cntnt-cntr">
                    	<p>There's a place for you on our volunteer team!</p>
                        <p class="margin-top-ten">When you give of your time to help others, you will touch lives while enriching your own</p>
                    </div>
                </div> 
					...
					<ul>
                        ...
                        <li>
							<div class="contact-row">
								<div class="outer-field-wrap">
									<div class="outer-field">
										<input type="text" placeholder="Favorite School Name " value="${schoolDetail.schoolName}" readonly="readonly"/>
									</div>
								</div>
							</div>
						</li>
							...
							<div class="contact-row">
								<div class="outer-field-wrap">
									<div class="outer-field_sel">
										 <form:select path="affiliationType" onchange="whereAboutIE(this.value);">
             ...
             <!--    <div class="i-agree">
					...
					<label for="check" name="tnc" id="tnc">I agree to End User
					<a href="#term-condition"  class="fancybox">Licence</a>
					Agreement.</label></p>
				</div> -->
               ...
               <form:input type="hidden" path="schoolIds" value="${schoolDetail.schoolId}"/>
               </form:form>
            </div>
            </div>
        </div>
