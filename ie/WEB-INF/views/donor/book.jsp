   ...
   <%@include file="header.jsp" %>
    ...
    <div class="inner_wrapper"> 
        ...
        <div class="about_us">
            <div class="content_inner">
                <div class="pracProgress_hdr">
                    ...
                    <input type="button" value="Ignore" onClick="location.href='<%=request.getContextPath()%>/donor/upgradeRadio';" 
			class="submit-btn fr"/>
                </div>
                <div class="container">
        ...
        <div class="amazon-book-buy">
        	<ul>
        		<li><a target="_blank" href="http://www.amazon.com/Master-Mindfulness-Superhero-Times-Stress/dp/1626254648"><img src="<%=request.getContextPath()%>/NewStyles/images/amazon-buy.png"></a></li>
                <li><a target="_blank" href="http://www.indiebound.org/book/9781626254640"><img src="<%=request.getContextPath()%>/NewStyles/images/amazon-buy-2.png"></a></li>
                <li><a target="_blank" href="http://www.barnesandnoble.com/w/master-of-mindfulness-laurie-grossman/1122294015?ean=9781626254640"><img src="<%=request.getContextPath()%>/NewStyles/images/amazon-buy-3.png"></a></li>
            </ul>
        </div>
    </section>
    </div>
