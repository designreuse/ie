...
<div class="wrapper">
    ...
    <div class="steps_getstarted">
     ...
     <div class="new_ty_video_main">
     	<%-- <img src="<%=request.getContextPath()%>/NewStyles/images/video.png" alt=""> --%>
     	...
     	<ul>
        	<li>
            	<div class="text-cntr-ty">
                    ...
                    <ul>
                    	<!-- <li>Receive Email from Brand Ambassador/Sponsor</li>
                        <li>Note down the Promo Code</li>
                        <li>Go to www.innerexplorer.org</li> -->
...
<%-- Our audio-guided programs are designed to run throughout the entire school year in 10-minute daily segments. Each semester series of 90 recordings is available on any networked device including a classroom computer or a smart phone. Each day, the classroom teacher plays a recording during a normal transition time (beginning of the school day or right after recess or lunch, for example), so it doesn’t impact the overall curriculum. The students and teacher listen to the recording and participate in the 2-minute journaling integration exercise at the end, which is included in the 10 minutes.<br><br>

<strong>There is a 4 step process to begin an Inner Explorer Program at your school:</strong><br><br>

    <strong>Initial Contact</strong> — contact us for a free consultation at 888-466-9732.<br><br>
    <strong>Site Assessment</strong> — based on the challenges you face, we’ll work together to create an implementation plan that addresses your needs and measures the results.<br><br>
    <strong>Training and Implementation</strong> — we’ll coordinate staff training, a communication plan, and classroom implementation plans that provide a quick start for teachers and students.<br><br>
    <strong>Customer Service</strong> — our team is available to conduct ongoing analysis of student achievement, to answer questions, to coordinate the addition of more classrooms, and to help facilitate community outreach activities.<br><br>
 --%>
                        ...
                        <div>
                        	Each school and district implementation will be different, however, on average the cost is $35 per student.  <span><a href="javascript:;">Please call or email us</a></span> for a quote for your school.
                        </div>
                        <h1>Is there teacher training?</h1>
                        <div>
                        	Yes, there is teacher training and a curriculum kit with related program tools for each classroom. The teacher training can be done on-site or online and takes less than 1 hour. The Inner Explorer Program is automated and does not require teacher prep or planning time. Research has shown that teachers who participate along with students in the 10-minute program experience a significant reduction in stress.
                        </div> --%>
