								...
								<table class="table table-striped table-bordered table-hover"	id="sample_1">
									<thead>
										...
										<c:forEach var="dtoUser" items="${dtoUser}">
											<tr>
												<td><span class="fd_span">${dtoUser.childName}</span></td>
												<td><span class="fd_span">${dtoUser.teacherName}</span></td>
												<td><span class="fd_span">${dtoUser.schoolName}</span></td>
												 <td><span class="fd_span">${dtoUser.address}</span></td> 
											</tr>
										</c:forEach>
										</tbody>
