    ...
    <div class="inner_wrapper">
    	<div class="about_us">
        	<div class="content_inner">
                ...
                <form:form name="petitionForm" id="petitionForm" modelAttribute="dtoUser" action="postComment" enctype="multipart/form-data">
                <form:input path="parentTeacherId" type="hidden" name="parentTeacherId" value="${parentTeacherId}"/>
                <div class="containerSmall" id="petitionContent" style="display: none;">
							...
							<ul>
                                ...
                                <li>
									<div class="contact-row">
										<div class="outer-field-wrap">
											<div class="outer-field">
												<form:input type="text" placeholder="Last Name" path="lastName" readonly="true"/>
											</div>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="contact-row">
										<div class="outer-field-wrap">
											<div class="outer-field">
												<form:input type="text" placeholder="Mobile Number" path="mobile" readonly="true"/>
											</div>
										</div>
									</div>
								</li>
                    ...
                    <div class="user-comments">
                        ...
                        <c:forEach var="comment" items="${comments}">
                        	<li>
                            	<h4>${comment.parentTeacher.parentDetail.firstName} ${comment.parentTeacher.parentDetail.lastName}</h4>
                                <p>${comment.comment}</p>
...
<%--                             <li>
                            	<h4>Tavis Smiley</h4>
                                <p>Quisque dapibus et ex in pulvinar. Aliquam lorem turpis, mattis aliquam eleifend vel, finibus sed diam. </p>
                                <img src="<%=request.getContextPath()%>/NewStyles/images/petition-video.jpg">
                            </li>
                            <li>
                            	<h4>Andrew Phillip</h4>
                                <p>Quisque dapibus et ex in pulvinar. Aliquam lorem turpis, mattis aliquam eleifend vel, finibus sed diam. Donec orci dolor, gravida ac euismod in, mollis eu nulla. Nam egestas fringilla dictum. Duis felis massa, maximus in neque in, lobortis eleifend purus. </p>
                            </li>
                            <li>
                            	<h4>Hanna Davis</h4>
                                <p>Donec orci dolor, gravida ac euismod in, mollis eu nulla. Nam egestas fringilla dictum. </p>
                                <img src="<%=request.getContextPath()%>/NewStyles/images/pop-slide-1.jpg">
                            </li> --%>
                            </c:forEach>
                        </ul>
                    </div>   
