			...
			<div class="steps_getstarted">
				<div class="containerSmall">
					...
					<div class="thankyou_content">
						<p>You have already make the contribution for this Campaign.</p>
					</div>

			<%-- 		<audio preload="none" class="mp3_playerbar_notes_rgt music_full"
						controls>
						<source
							src="<%=request.getContextPath()%>/audioFiles/getStarted.mp3"
							type="audio/mpeg">
					</audio> --%>
								...
								<ul>
									<li>
										...
										<div class="act-sharing-new"
											...
											<%-- <div >
											<span><a href="<%=request.getContextPath()%>/sendEmailDonor">Claim Your Free Membership</a></span>
											</div> --%>
											<div class="info_btn thnkupg-btn"> 
																				<a href="<%=request.getContextPath()%>/sendEmailDonor">
