			...
			<div class="containerSmall">
				...
				<div class="techVideoSct" align="center">
					<iframe width="77%" height="335"
						src="https://www.youtube.com/embed/XXEc8ybDXRw?enablejsapi=1&playerapiid=myvideo&version=3&rel=0"
				...
				<div class="videobtn">
					<input type="button" title="PROCEED TO NEXT STEP"
						...
						onclick="location.href = '<%=request.getContextPath()%>/teacher/step4';" />
				</div>
			</div>
		</section>
	</div>
