...
<%-- 			            		<c:if test="${firstLogin == 'N'}">
				...
				<div class="techVideoSct" align="center">
				 <iframe width="77%" height="335" src="https://www.youtube.com/embed/XXEc8ybDXRw?enablejsapi=1&playerapiid=myvideo&version=3&rel=0" frameborder="0" allowfullscreen></iframe>
				...
				<div class="videobtn">
					<input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/teacher/teacher-dash-step2';" />
				</div>
			</div>
		</section>
	</div>
