			...
			<div class="containerSmall">
				...
				<div class="techVideoSct" align="center">
					<iframe width="77%" height="335"
						src="https://www.youtube.com/embed/kk7IBwuhXWM?enablejsapi=1&playerapiid=myvideo&version=3&rel=0"
				...
				<div class="videobtn">
					<input type="button" title="PROCEED TO NEXT STEP"
						...
						onclick="location.href = '<%=request.getContextPath()%>/teacher/training2';" />
