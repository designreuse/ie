			...
			<div class="round-steps-outer">
				<div class="chain">
					<ul>
						...
						<li class="activeCircle"><a
							href="<%=request.getContextPath()%>/teacher/training2" class="chain_t_circle">
								<h3>Day 2</h3>
						</a></li>

						<li class="greyclass"><a
							href="<%=request.getContextPath()%>/teacher/training3" class="chain_t_circle">
								<h3>Day 3</h3>
						</a></li>
						<li class="greyclass"><a
							href="<%=request.getContextPath()%>/teacher/training4" class="chain_t_circle">
								<h3>Day 4</h3>
						</a></li>
						<li class="greyclass"><a
							href="<%=request.getContextPath()%>/teacher/training5" class="chain_t_circle">
								<h3>Day 5</h3>
						</a></li>
				...
				<div class="ur_grid margin-auto float-none width-60">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody>
							...
							<tr>
								<td><p>Questionaire</p></td>
								<td><p>September 23, 2016</p></td>
								<td><p>
										<a id="pdfopenbt" class="cntr" data-toggle="modal"
											data-target="#pdfmod" role="button " title="Download"
											style="color: green;"><i class="fa fa-download dw"></i></a>
									</p></td>
							</tr>
		...
		<c:if test="${companyName eq '1'}">
			...
			<div class="videobtn">
				<input type="button" title="PROCEED TO NEXT STEP"
					...
					onclick="location.href = '<%=request.getContextPath()%>/teacher/training3';" />
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" id="closebtn"
						class="btn btn-success pull-right" data-dismiss="modal">Close</button>

					<h4 class="modal-title" id="myModalLabel">Questionaire</h4>
				</div>
				<div class="modal-body">
					<iframe src="/ie/NewStyles/pdf/Questionaire-1.pdf" width="100%"
