		...
		<div class="containerSmall">
			...
			<div class="containerSmall">
				...
				<div class="chain">
				 ...
				 <iframe width="77%" height="335" src="https://www.youtube.com/embed/Di5uNbdkW9s?enablejsapi=1&playerapiid=myvideo&version=3&rel=0" frameborder="0" allowfullscreen></iframe>
				...
				<div class="videobtn">
					<input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/teacher/training4';" />
				</div>
			</div>
		</section>
	</div>
