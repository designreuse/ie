								...
								<div class="pracProgress_hdr">
									<div class="outer-grn-list">
										<div class="right-grn-list">
											...
											<input class="transction-button hdr-btn-clr " value="Bonus Track" style="cursor:pointer" type="button" onclick="location.href = '<%=request.getContextPath()%>/teacher/bonusTrack';">
										    </div> --%>
							...
							<div class="ie_pra-player">
								<div class="container">
										<div class="col-md-12 transction-btn" style="text-align:left !important">
											<input class="transction-button hdr-btn-clr " value="Daily Tracks" style="cursor:pointer; background-color: white !important; color: #02a451;" type="button" onclick="location.href = '<%=request.getContextPath()%>/teacher/mindful-practice-new';">
											<input class="transction-button hdr-btn-clr " value="Transition Tracks" style="cursor:pointer;" type="button" onclick="location.href = '<%=request.getContextPath()%>/teacher/bonusTrack';">
										    </div>
									<div id="circle"></div>
...
function initDialog(){
	...
	$(document).ready(function($){
		 /*  document.getElementsByClassName("highcharts-title")[0].style.display="block"
