...
<%-- 			            		</c:if> --%>
            ...
            <div class="misc_tabar margin-top-zero">
                <ul>
                    <li id="mtab2" ><a class="trial" href="javascript:showTab(2,3)">Additional Materials</a></li>
   ...
   <!--  </div> -->
    <!--inner_wrapper ends--> 
          ...
          <div class="videobtn">
<%--           	<c:if test="${firstLogin == 'N'}">
				<input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/teacher/teacher-dash-step3';" />
			</c:if>
			<c:if test="${firstLogin == 'Y'}"> --%>
				<c:if test="${companyName eq '1'}">
			    <input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/teacher/teacher-dash-step4';" />
			    </c:if>
			    <c:if test="${companyName eq '2'}">
			    <input type="button" title="PROCEED TO NEXT STEP" value="PROCEED TO NEXT STEP"  class="blueBtn" onclick="location.href = '<%=request.getContextPath()%>/teacher/teacher-dash-step6';" />
			    </c:if>
