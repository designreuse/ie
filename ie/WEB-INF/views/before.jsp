...
<body>
			...
			<div class="navbar-header col-md-12 col-sm-12">
				<div class="navbar-header col-sm-5 p00">
					...
					<a class="navbar-brand" href="#"><img
						src="<%=request.getContextPath()%>/NewStyles/img/logo.png"
						alt="face" class="img-responsive logo_hh" /></a>
					<p class="brand_nam">HELP HEAL PROJECT</p>
					<i class="fS12">Powered by – Inner Explorer & Small Strides
						Foundation</i>
				</div>
				<div class="navbar-header col-sm-7 p00">
					<strong class="titl_top">BEFORE PRACTICE</strong>
				</div>
			</div>
	...
	<div class="main_wrapper_innerPage mT100-1">
		<!-- <section class="inner_sec_banner">
			<div class="banner-inner hero">
				 <img class="" src="https://appleid.cdn-apple.com/static/bin/cb401238999/dist/assets/images/apple_id_recovery_2880x340.jpg" alt="First slide">
				<div class="container">
		...
		<section class="form_inner_secP">
			<div class="container">
				<div class="row">
					...
					<div class="price-box  pull-left col-md-12">
						<div class="col-md-12">
							<div class="col-md-12 pull-left">
								<h2>SELECT PAIN LEVEL</h2>
							</div>

							<form class="form-horizontal form-pricing pForm" role="form"
								action="updatePainLevel" method="post">
								...
								<div class="price-form pull-left col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-12 text-center">
											<input type="hidden" id="amount" name="painAmountBefore"
												class="form-control">
								...
								<div class="col-sm-12 text-center">
									...
									<button type="submit" class="btn btn-primary"
										style="font-size: 20px;">START PRACTICE</button>
									</a>
								</div>
							</form>
						</div>
	...
	<script>
		window.jQuery
				|| document
						.write('<script src="<%=request.getContextPath()%>
		/NewStyles/assets/js/vendor/jquery.min.js"><\/script>')
	</script>
	<script
