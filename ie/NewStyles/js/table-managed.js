...
/*            jQuery('#sample_1 .group-checkable').change(function () {
            ...
            jQuery('#sample_2_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            //jQuery('#sample_2_wrapper .dataTables_info ').attr("style","display:none");
            //jQuery('#sample_2_wrapper .dataTables_paginate ').attr("style","display:none");
            //jQuery('#sample_2_wrapper .dataTables_length ').attr("style","display:none");
            //jQuery('#sample_1_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
            
            $('[id^=sample_3]').dataTable({
                "aoColumns": [
                  { "bSortable": true },
                  { "bSortable": true },
                  { "bSortable": true },
...
/*            jQuery('#sample_1 .group-checkable').change(function () {
            ...
            //jQuery('#sample_4_wrapper .dataTables_info ').attr("style","display:none");
            //jQuery('#sample_4_wrapper .dataTables_paginate ').attr("style","display:none");
            //jQuery('#sample_4_wrapper .dataTables_length ').attr("style","display:none");
            //jQuery('#sample_1_wrapper .dataTables_length select').select2(); // initialize select2 dropdown
            
            $('[id^=sample_5]').dataTable({
                "aoColumns": [
                  { "bSortable": true },
                  { "bSortable": true },
                  { "bSortable": true },
...
/*            jQuery('#sample_1 .group-checkable').change(function () {
            ...
            jQuery('#sample_5_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            ...
            jQuery('#sample_6_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#sample_6_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            ...
            jQuery('#sample_16_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#sample_16_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
        }
